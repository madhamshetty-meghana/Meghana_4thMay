...
${BROWSER}                chrome
${username}               minipapercraft.ideas.9074e1032754@agentforce.com
${login_url}              https://orgfarm-ffcca4a059-dev-ed.develop.lightning.force.com/            # Salesforce instance. NOTE: Should be overwritten in CRT variables
